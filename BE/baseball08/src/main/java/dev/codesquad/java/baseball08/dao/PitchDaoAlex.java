...
public class PitchDaoAlex {
    ...
    public PlayballDto findDataToPlayGame(Long gameId) {
        String sql = "SELECT g.home_total_score AS ht_score , g.away_total_score AS at_score , " +
                "i.home_score as h_score , i.away_score as a_score , i.strike_count , i.ball_count , i.out_count , i.base_count , i.top_bottom , i.home_name , i.away_name , " +
        ...
        return jdbcTemplate.queryForObject(sql,new Object[]{gameId},
                ...
                .homeTotalScore(rs.getInt("ht_score")).awayTotalScore(rs.getInt("at_score"))
                        .homeScore(rs.getInt("h_score")).awayScore(rs.getInt("a_score"))
    ...
    public String findHitterByTeamId(Long teamId) {
        String sql = "SELECT t.hitter FROM team t WHERE t.id = ?";
        return jdbcTemplate.queryForObject(sql,new Object[]{teamId},
                (rs, rowNum) -> rs.getString("hitter"));
    }
}
